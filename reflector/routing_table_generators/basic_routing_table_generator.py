...
class BasicRoutingTableGenerator(object):
    ...
    def __call__(self, routing_infos, routing_table_by_partitions, machine):
        """ creates routing table entries for a 4 chip board for reflecting
        multicast packets back out the spinn link they came from

        :param routing_infos: paths
        :param routing_table_by_partitions: tables per partition
        :param machine: spinn machine
        :return: routing tables that just bounce back.
        """
